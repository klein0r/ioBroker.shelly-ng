...
export namespace Rpc {
    ...
    export namespace Shelly {
        ...
        export type GetConfigResult = ResponseResult & {};

        export type GetComponentsRequest = Request & {
            method: 'Shelly.GetComponents';
            params?: {
                offset?: number;
                include?: Array<'config' | 'status'>;
                dynamic_only?: boolean;
            };
        };

        export type GetComponentsResultComponent = {
            key: string;
            status: object;
            config: object;
        };

        export type GetComponentsResult = ResponseResult & {
            components: Array<GetComponentsResultComponent>;
            cfg_rev: number;
            offset: number;
            total: number;
        };

        export type ListMethodsRequest = Request & {
            method: 'Shelly.ListMethods';
        };

        export type ListMethodsResult = ResponseResult & {
...
export class MQTTClient extends BaseClient {
    ...
    public async publishRpcMsg(request: Rpc.Shelly.GetConfigRequest): Promise<Rpc.Shelly.GetConfigResult>;
    public async publishRpcMsg(request: Rpc.Shelly.GetComponentsRequest): Promise<Rpc.Shelly.GetComponentsResult>;
    public async publishRpcMsg(request: Rpc.Shelly.ListMethodsRequest): Promise<Rpc.Shelly.ListMethodsResult>;
